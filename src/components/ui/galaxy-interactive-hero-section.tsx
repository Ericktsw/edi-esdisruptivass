    ...
    <div className="relative gradient-hero">
      ...
      <div className="relative min-h-screen">
        <div className="absolute inset-0 z-0 pointer-events-auto">
          <Suspense fallback={<div className="w-full h-screen gradient-hero flex items-center justify-center text-white">Loading...</div>}>
      ...
      <div className="gradient-hero relative z-10" style={{ marginTop: '-10vh' }}>
